...
const CourseSection: FC = () => {
    const courses: Course[] = [{
        ...
        disabled: true,
        url: "https://java.kadenfrisk.com/",
    }, {
        image: reactCourseImage,
        title: "React",
        description: "While React is not an entire language on its own, it is a very popular library for building user interfaces. (Coming Soon!)",
        disabled: true,
